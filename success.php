    ...
    <div class="relative isolate px-4 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-16 sm:py-48 lg:py-56">
          <div class="text-center">
            <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-6xl">Ваша заявка <br> Успешно отправлена!</h1>
            
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <a href="/index.php" class="rounded-md bg-onbutton px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-buttonhover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">На главную</a>

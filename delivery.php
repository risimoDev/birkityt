          ...
          <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
            <div class="flex relative pb-12">
              ...
              <div class="flex-grow pl-4">
                <h2 class="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Шаг 1</h2>
                <p class="leading-relaxed">Оставляете заявку на сайте или звоните нам напрямую и мы принимаем заказ</p>
              </div>
            </div>
            <div class="flex relative pb-12">
              <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
              ...
              <div class="flex-grow pl-4">
                <h2 class="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Шаг 2</h2>
                <p class="leading-relaxed">Оплачиваете ваш заказ, после чего ожидаете макета от наших специалистов</p>
              </div>
            </div>
            <div class="flex relative pb-12">
              <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
              ...
              <div class="flex-grow pl-4">
                <h2 class="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Шаг 3</h2>
                <p class="leading-relaxed">Мы начинаем производить продукцию, время изготовления подскажет менеджер</p>
              </div>
            </div>
            <div class="flex relative pb-12">
              <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
              ...
              <div class="flex-grow pl-4">
                <h2 class="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Шаг 4</h2>
                <p class="leading-relaxed">Когда продукция будет готова, мы создаем СДЕК или забираете самовывозом из офиса в г. Пермь</p>
              </div>
            </div>
            <div class="flex relative">
              ...
              <div class="flex-grow pl-4">
                <h2 class="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Финиш!</h2>
                <p class="leading-relaxed">Ура! Продукция у вас, не забывайте оставлять отзывы</p>
              </div>
            </div>
          </div>
         ...
         <div class="flex items-center -mx-3 sm:-mx-4">
            <div class="w-full px-3 sm:px-4 xl:w-1/2">
               <div class="py-3 sm:py-4">
                  <img
                     src="public/images/banners/one.jpg"
                     alt=""
               ...
               <div class="py-3 sm:py-4">
                  <img
                     src="public/images/banners/two.jpg"
                     alt=""
                     class="w-full rounded-2xl"
                     />
               </div>
            ...
            <div class="w-full px-3 sm:px-4 xl:w-1/2">
               <div class="relative z-10 my-4">
                  <img
                     src="public/images/banners/three.jpg"
                     alt=""
                     class="w-full rounded-2xl"
                     />

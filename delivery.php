...
<section class="text-gray-600 body-font">
   <div class="container px-5 py-24 mx-auto flex flex-wrap">
      <h2 class="mb-16 text-3xl font-extrabold text-textColorDark text-center mx-auto text-black">
         <?php echo content_get('delivery.title', 'Доставка и оплата'); ?>
      </h2>
      <p class="text-center text-textColor mb-12">
         <?php echo content_get('delivery.description', 'Условия доставки, сроки и доступные способы оплаты.'); ?></p>
      <div class="flex flex-wrap w-full">
         <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
            <div class="flex relative pb-12">
               ...
               <div
                  class="flex-shrink-0 w-10 h-10 rounded-full bg-onbutton inline-flex items-center justify-center text-white relative z-10">
               ...
               <div class="flex-grow pl-4">
                  <h2 class="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">
                     <?php echo content_get('delivery.step1.title', 'Шаг 1'); ?></h2>
                  <p class="leading-relaxed">
                     <?php echo content_get('delivery.step1.text', 'Оставляете заявку на сайте или звоните нам напрямую и мы принимаем заказ'); ?>
                  </p>
               </div>
            </div>
            <div class="flex relative pb-12">
               ...
               <div class="flex-grow pl-4">
                  <h2 class="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">
                     <?php echo content_get('delivery.step2.title', 'Шаг 2'); ?></h2>
                  <p class="leading-relaxed">
                     <?php echo content_get('delivery.step2.text', 'Оплачиваете ваш заказ, после чего ожидаете макета от наших специалистов'); ?>
                  </p>
               </div>
            </div>
            <div class="flex relative pb-12">
               ...
               <div class="flex-grow pl-4">
                  <h2 class="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">
                     <?php echo content_get('delivery.step3.title', 'Шаг 3'); ?></h2>
                  <p class="leading-relaxed">
                     <?php echo content_get('delivery.step3.text', 'Мы начинаем производить продукцию, время изготовления подскажет менеджер'); ?>
                  </p>
               </div>
            </div>
            <div class="flex relative pb-12">
               ...
               <div class="flex-grow pl-4">
                  <h2 class="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">
                     <?php echo content_get('delivery.step4.title', 'Шаг 4'); ?></h2>
                  <p class="leading-relaxed">
                     <?php echo content_get('delivery.step4.text', 'Когда продукция будет готова, мы создаем СДЕК или забираете самовывозом из офиса в г. Пермь'); ?>
                  </p>
               </div>
            </div>
            <div class="flex relative">
               ...
               <div class="flex-grow pl-4">
                  <h2 class="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">
                     <?php echo content_get('delivery.finish.title', 'Финиш!'); ?></h2>
                  <p class="leading-relaxed">
                     <?php echo content_get('delivery.finish.text', 'Ура! Продукция у вас, не забывайте оставлять отзывы'); ?>
                  </p>
               </div>
            </div>
         </div>
            ...
            <div class="flex items-center -mx-3 sm:-mx-4">
               <div class="w-full px-3 sm:px-4 xl:w-1/2">
                  <div class="py-3 sm:py-4">
                     <img src="public/images/banners/one.jpg" alt="Этапы работы: заявка" loading="lazy"
                        class="w-full rounded-2xl" />
                  </div>
                  <div class="py-3 sm:py-4">
                     <img src="public/images/banners/two.jpg" alt="Этапы работы: оплата и макет" loading="lazy"
                        class="w-full rounded-2xl" />
                  </div>
               </div>
               <div class="w-full px-3 sm:px-4 xl:w-1/2">
                  <div class="relative z-10 my-4">
                     <img src="public/images/banners/three.jpg" alt="Этапы работы: производство" loading="lazy"
                        class="w-full rounded-2xl" />
                     <span class="absolute -right-7 -bottom-7 z-[-1]">
                        <svg width="134" height="106" viewBox="0 0 134 106" fill="none"
                           ...
                           <circle cx="16.3333" cy="89.3333" r="1.66667" transform="rotate(-90 16.3333 89.3333)"
                              fill="#A1B5D8" />
                           <circle cx="31" cy="89.3333" r="1.66667" transform="rotate(-90 31 89.3333)" fill="#A1B5D8" />
                           ...
                           <circle cx="16.3333" cy="31.0003" r="1.66667" transform="rotate(-90 16.3333 31.0003)"
                              fill="#A1B5D8" />
                           <circle cx="31" cy="74.6668" r="1.66667" transform="rotate(-90 31 74.6668)" fill="#A1B5D8" />
                           <circle cx="31" cy="31.0003" r="1.66667" transform="rotate(-90 31 31.0003)" fill="#A1B5D8" />
                           ...
                           <circle cx="16.3333" cy="16.3333" r="1.66667" transform="rotate(-90 16.3333 16.3333)"
                              fill="#A1B5D8" />
                           <circle cx="31" cy="60.0003" r="1.66667" transform="rotate(-90 31 60.0003)" fill="#A1B5D8" />
                           <circle cx="31" cy="16.3333" r="1.66667" transform="rotate(-90 31 16.3333)" fill="#A1B5D8" />
                           ...
                           <circle cx="16.3333" cy="1.66683" r="1.66667" transform="rotate(-90 16.3333 1.66683)"
                              fill="#A1B5D8" />
                           <circle cx="31" cy="45.3333" r="1.66667" transform="rotate(-90 31 45.3333)" fill="#A1B5D8" />
                           <circle cx="31" cy="1.66683" r="1.66667" transform="rotate(-90 31 1.66683)" fill="#A1B5D8" />
